...
public class ParksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parks.add(new Location(R.string.carriage_way_name, R.string.carriage_way_address, R.string.carriage_way_phone, R.string.carriage_way_desc, R.drawable.placeholder));
        parks.add(new Location(R.string.finley_name, R.string.finley_address, R.string.finley_phone, R.string.finley_desc));
        parks.add(new Location(R.string.nature_center_name, R.string.nature_center_address, R.string.nature_center_phone, R.string.nature_center_desc));
